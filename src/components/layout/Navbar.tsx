      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 opacity-30 blur-lg transition-opacity duration-300 group-hover:opacity-50"></div>
              <div className="relative rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-3 shadow-lg transition-shadow duration-300 group-hover:shadow-xl">
                <BookOpen className="h-6 w-6 text-white" />
              </div>
            </div>
            <div className="ml-4">
          ...
          <div className="hidden items-center space-x-6 md:flex">
            {user ? (
              <div className="flex items-center space-x-6">
                {/* User Profile */}
                <div className="flex items-center space-x-3 rounded-2xl border border-slate-200/60 bg-gradient-to-r from-slate-50 to-blue-50 px-4 py-2 shadow-sm">
                  <div className="relative">
                ...
                <div className="group relative">
                  <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-red-200 to-pink-200 opacity-0 blur transition-opacity duration-300 group-hover:opacity-100"></div>
                  <button
                    onClick={handleLogout}
                    className="relative flex items-center space-x-2 rounded-xl border border-red-200 bg-white px-6 py-3 font-semibold text-red-600 shadow-sm transition-all duration-300 group-hover:border-red-300 hover:bg-red-50 hover:text-red-700 hover:shadow-md"
                  >
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={handleLogin}
                  className="rounded-xl border border-slate-200 bg-white/80 px-6 py-3 font-semibold text-slate-700 shadow-sm backdrop-blur-sm transition-all duration-300 hover:border-slate-300 hover:bg-white hover:text-slate-900 hover:shadow-md"
                >
                  Masuk
                </button>
                ...
                {/* Register Button */}
                <div className="group relative">
                  <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-blue-200 to-indigo-200 opacity-75 blur transition-opacity duration-300 group-hover:opacity-100"></div>
                  <button
                    onClick={handleRegister}
                    className="relative transform rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl"
                  >
                    Daftar Sekarang
                  </button>
                </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="rounded-xl border border-slate-200 bg-white/80 p-3 shadow-sm transition-all duration-300 hover:shadow-md"
            >
              {isMobileMenuOpen ? (
